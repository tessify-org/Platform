                    ...
                    <div id="group" class="elevation-2">
                        ...
                        <div id="group-header">
                            ...
                            <div id="group-header__text">
                                ...
                                <h2 id="group-subtitle">@lang("groups.leave_title")</h2>
                            </div>
                        </div>
                        ...
                        <div id="group-content">
                            ...
                            <form action="{{ route('group.leave.post', $group->slug) }}" method="post">
                                @csrf

                                <p>@lang("groups.leave_text")</p>

                                <div class="form-controls">
                                    <div class="form-controls__left">
                                        <v-btn text href="{{ route('group', $group->slug) }}">
                                            <i class="fas fa-arrow-left"></i>
                                            @lang("groups.leave_cancel")
                                        </v-btn>
                                    </div>
                                    <div class="form-controls__right">
                                        <v-btn dark depressed type="submit" color="red">
                                            <i class="fas fa-save"></i>
                                            @lang("groups.leave_submit")
                                        </v-btn>
                                    </div>
                                </div>
