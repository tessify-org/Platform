...
@section("breadcrumbs")
    {!! Breadcrumbs::render("group.forum.create-thread", $group, $forum) !!}
@stop
                    ...
                    <div id="group" class="elevation-2">
                        ...
                        <div id="group-header">
                            ...
                            <div id="group-header__text">
                                <h1 id="group-title">@lang("forums.threads_create_title")</h1>
                        ...
                        <div id="group-content">
                            ...
                            <form action="{{ route('group.forum.create-thread.post', ['slug' => $group->slug, 'forumSlug' => $forum->slug]) }}" method="post">
                                @csrf
                                <forum-thread-form
                                    :group="{{ $group->toJson() }}"
