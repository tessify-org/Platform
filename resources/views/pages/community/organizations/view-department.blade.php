            ...
            <div id="department-header__content">
                ...
                <div id="department-header__actions">
                    <v-btn href="{{ route('organizations.view', $organization->slug) }}" color="white" outlined>
                        ...
                        @lang("organizations.department_back_to_organization", ["name" => $organization->name])
                    </v-btn>
                </div>
            </div>
        </div>
                ...
                <div class="content-section">
                    ...
                    <div class="content-card elevation-1 mb">
                        <div class="content-card__content">
                            <h3 class="content-subtitle">@lang("organizations.view_details")</h3>
                            <div class="details no-padding mb-0">
                                <!-- Ministry -->
                                <div class="detail">
                                    <div class="key">@lang("organizations.department_ministry")</div>
                                    <div class="val">
                                ...
                                <!-- Organization -->
                                <div class="detail">
                                    <div class="key">@lang("organizations.department_organization")</div>
                                    <div class="val">
                                ...
                                <!-- Name -->
                                <div class="detail">
                                    <div class="key">@lang("organizations.department_name")</div>
                                    <div class="val">{{ $department->name }}</div> 
                                </div>
                                <!-- Description -->
                                @if (!is_null($department->description))
                                    <div class="detail">
                                        <div class="key">@lang("organizations.department_description")</div>
                                ...
                                @if (!is_null($department->website_url))
                                    <div class="detail">
                                        <div class="key">@lang("organizations.department_website")</div>
                                        <div class="val">
                    ...
                    <div class="content-card elevation-1 mb">
                        <div class="content-card__content">
                            <h3 class="content-subtitle">@lang("organizations.department_projects")</h3>
                            <div id="ministry-projects">
                                ...
                                @else
                                    <div id="no-projects">
                                        @lang("organizations.department_no_projects")
                                    </div>  
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="content-card elevation-1">
                        <div class="content-card__content">
                            <h3 class="content-subtitle">@lang("organizations.department_tasks")</h3>
                            <div id="ministry-tasks">
                                ...
                                @else
                                    <div id="no-tasks">
                                        @lang("organizations.department_no_tasks")
                                    </div>  
                                @endif
                            </div>
                        </div>
