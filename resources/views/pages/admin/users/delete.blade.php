...
@section("content")
    <div class="content-section__wrapper">
        <div class="content-section">
            ...
            <h1 class="page-title centered">@lang("admin.users_delete_title")</h1>
