...
@section("content")
    <div class="content-section__wrapper">
        <div class="content-section">
            ...
            <h1 class="page-title centered">@lang("admin.users_view_title")</h1>
                ...
                <div id="admin-users-view__left">
                    ...
                    <div class="content-card elevation-1">
                        <div class="details">
                            ...
                            <!-- Admin -->
                            <div class="detail">
                                <div class="key">@lang("admin.users_view_admin")</div>
                                <div class="val">
                                    @if ($user->is_admin)
                                        <span class="green-text">@lang("general.yes")</span>
                                    @else
                                        <span class="red-text">@lang("general.no")</span>
                                    @endif
                                </div>
                            </div>
                            <!-- Name -->
                            <div class="detail">
                                <div class="key">@lang("admin.users_view_name")</div>
                                <div class="val">{{ $user->formattedName }}</div>
                            </div>
                            <!-- Email -->
                            <div class="detail">
                                <div class="key">@lang("admin.users_view_email")</div>
                                <div class="val">{{ $user->email }}</div>
                            </div>
                            <!-- Email verified -->
                            <div class="detail">
                                <div class="key">@lang("admin.users_view_email_verified")</div>
                                <div class="val">
                            ...
                            <!-- Phone number -->
                            <div class="detail">
                                <div class="key">@lang("admin.users_view_phone")</div>
                                <div class="val">
                                    @if ($user->phone)
                                        {{ $user->phone }}
                                    @else
                            ...
                            <!-- Headline -->
                            <div class="detail">
                                <div class="key">@lang("admin.users_view_headline")</div>
                            ...
                            <!-- Reputation points -->
                            <div class="detail">
                                <div class="key">@lang("admin.users_view_reputation")</div>
                                <div class="val">{{ $user->reputation_points }}</div>
                            </div>
                            <!-- Has been checked -->
                            <div class="detail">
                                <div class="key">@lang("admin.users_view_checked")</div>
                                <div class="val">
                            ...
                            <!-- Banned -->
                            <div class="detail">
                                <div class="key">@lang("admin.users_view_banned")</div>
                                <div class="val">
                                    @if ($user->permabanned)
                                        <span class="red-text">@lang("admin.users_view_banned_permanently")</span>
                                    @elseif ($user->banned_until)
                                        <span class="red-text">@lang("admin.users_view_banned_temporarily")</span>
                                        <span style="margin: 0 0 0 10px;">({{ $user->banned_until->format("d-m-Y H:m:s") }})</span>
                                    @else
                                        <span class="green-text">@lang("general.no")</span>
                                    @endif
                                </div>
                            </div>
                            <!-- Updated at -->
                            <div class="detail">
                                <div class="key">@lang("general.updated_at")</div>
                                <div class="val">{{ $user->updated_at->format("d-m-Y H:m:s") }}</div>
                            </div>
                            <!-- Created at -->
                            <div class="detail">
                                <div class="key">@lang("general.created_at")</div>
