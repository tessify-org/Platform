...
@section("content")
    <div class="content-section__wrapper">
        <div class="content-section">
            ...
            <!-- Title -->
            <h1 class="page-title centered">@lang("reviews.view_title")</h1>
            ...
            <div id="review-wrapper">
                ...
                <div id="review" class="elevation-1">
                    ...
                    <div id="review-rating">
                        <div id="review-rating__label">@lang("reviews.view_rating")</div>
                        <div id="review-rating__value">{{ $review->rating."/10" }}</div>
                    </div>
                    
                    <!-- Message -->
                    <div id="review-message">
                        <div id="review-message__label">@lang("reviews.view_message")</div>
                        <div id="review-message__value">{!! nl2br($review->message) !!}</div>
                    </div>
                    
                    <!-- Public -->
                    <div id="review-public">
                        <div id="review-public__label">@lang("reviews.view_public")</div>
