        ...
        <div class="content-section">
            ...
            <form action="{{ route('projects.team.roles.create.post', $project->slug) }}" method="post">
                ...
                <project-team-role-form
                    ...
                    name-text="@lang('projects.create_role_name')"
                    description-text="@lang('projects.create_role_description')"
                    positions-text="@lang('projects.create_role_positions')"
                    back-href="{{ route('projects.team.view', $project->slug) }}"
                    back-text="@lang('projects.create_role_back')"
                    submit-text="@lang('projects.create_role_submit')">
                </project-team-role-form>
