    ...
    <div class="content-section__wrapper">
        <div class="content-section">
            ...
            <h1 id="delete-dialog__title" class="page-title centered">
                @lang("projects.change_roles_title")
            </h1>
            ...
            <form action="{{ route('projects.team.change-roles.post', ['slug' => $project->slug, 'userSlug' => $user->slug]) }}" method="post">
                ...
                <project-team-member-change-roles-form
                    ...
                    project-text="@lang('projects.change_roles_project')"
                    user-text="@lang('projects.change_roles_user')"
                    role-text="@lang('projects.change_roles_role')"
                    select-role-text="@lang('projects.change_roles_select_role')"
                    no-roles-text="@lang('projects.change_roles_no_roles_available')"
