            ...
            <div class="content-section pt50">
                ...
                <div class="content-box elevation-1">
                    <h3 class="content-subtitle">
                        @lang("projects.view_team_team_members")
                    </h3>
                                ...
                                <div class="team-member__wrapper">
                                    <div class="team-member">
                                        ...
                                        <div class="team-member__text-wrapper">
                                            ...
                                            <div class="team-member__title">@lang("general.as") <span>{{ $teamMember->title }}</span></div>
                                        </div>
                                        @can ("manage-team-members", $project)
                                            <div class="team-manager__actions">
                                                ...
                                                <v-tooltip bottom>
                                                    ...
                                                    <span>@lang("projects.view_team_change_roles")</span>
                                                </v-tooltip>
                                                <!-- Remove member -->
                                                @if ($teamMember->user_id != $user->id)
                                                    <v-tooltip bottom>
                                                        ...
                                                        <span>@lang("projects.view_team_remove_member")</span>
                                                    </v-tooltip>
                                                @endif
                                            </div>
                                        @endcan
                    ...
                    @else
                        <div id="no-team-members">
                            @lang("projects.view_team_no_team_members")
                        </div>
                    @endif
                ...
                <!-- Outstanding roles -->
                <div class="content-box elevation-1">
                    <h3 class="content-subtitle">@lang('projects.view_team_outstanding_roles')</h3>
                    <p>@lang('projects.view_team_outstanding_roles_intro')</p>
                                        ...
                                        @can("manage-team-roles", $project)
                                            <div class="team-role__actions">
                                                ...
                                                <v-tooltip bottom>
                                                    ...
                                                    <span>@lang("projects.view_team_assign_to_me")</span>
                                                </v-tooltip>
                                                <!-- Update -->
                                                <v-tooltip bottom>
                                                    <template v-slot:activator="{ on }">
                                                    ...
                                                    <span>@lang("projects.view_team_role_edit")</span>
                                                </v-tooltip>
                                                <!-- Delete -->
                                                <v-tooltip bottom>
                                                    <template v-slot:activator="{ on }">
                                                    ...
                                                    <span>@lang("projects.view_team_role_delete")</span>
                                                </v-tooltip>
                                            </div>
                                        @endcan
                                    </div>
                            ...
                            @can("manage-team-roles", $project)
                                <div id="team-roles__actions-right">
                                    <v-btn large depressed color="primary" href="{{ route('projects.team.roles.create', $project->slug) }}">
                                        ...
                                        @lang("projects.view_team_add_roles")
                                    </v-btn>
                                </div>
                            @endcan
                        </div>
                    @else
                        <div id="no-team-roles">@lang("projects.view_team_no_roles")</div>
                    @endif
                </div>
