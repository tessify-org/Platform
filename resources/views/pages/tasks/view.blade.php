                ...
                <main id="view-task__content">
                    ...
                    @if ($task->status->name != "completed" && $task->assigned_to_user)
                        <div id="task__report-progress" class="elevation-2">
                            ...
                            <div id="report-progress__text">@lang("tasks.view_awaiting_progress_text")</div>
                    ...
                    <div id="task" class="elevation-2">
                        ...
                        <div id="task-content">
                                    ...
                                    <div id="primary-action">
                                        ...
                                        @if ($task->status->name == "completed")
                                            ...
                                            <v-tooltip top>
                                                ...
                                                <span>@lang("tasks.view_join_disabled_completed")</span>
                                            </v-tooltip>
                                        ...
                                        @else
                                            ...
                                            @else
                                                ...
                                                <v-tooltip top>
                                                    ...
                                                    <span>@lang("tasks.view_join_disabled_no_positions")</span>
                                                </v-tooltip>
                                        ...
                                        <div class="secondary-action">
                                            @if (!Auth::user()->hasSubscribed($task))
                                                ...
                                                <v-tooltip bottom>
                                                    ...
                                                    <span>@lang("tasks.view_subscribe")</span>
                                                </v-tooltip>
                                            @else
                                                <!-- Unfollow button -->
                                                <v-tooltip bottom>
                                                    ...
                                                    <span>@lang("tasks.view_unsubscribe")</span>
                                                </v-tooltip>
                                            @endif
                                        </div>
                                        <div class="secondary-action">
                            ...
                            <div id="task-description">
                                <div id="task-description__title">@lang("tasks.view_description")</div>
                            ...
                            @if (count($task->skills))
                                <div id="task-required-skills">
                                    <div id="task-required-skills__title">@lang("tasks.view_skills")</div>
                            ...
                            <div id="task-location">
                                <div id="task-location__title">@lang("tasks.view_location")</div>
                                <div id="task-location__content">

                                    <!-- Remote -->
                                    <div id="remote-work">
                                        <div id="remote-work__title">@lang("tasks.view_remote_work_title")</div>
                                        <div id="remote-work__description">@lang("tasks.view_remote_work_description")</div>
                                    </div>
