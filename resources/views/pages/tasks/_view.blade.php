        ...
        @endif
            ...
            <div id="task-header__content">
                ...
                <div id="task-header__text">
                    ...
                    <div id="task-header__title-pretext">@lang("tasks.view_title")</div>
                    <!-- Header title -->
        ...
        <div id="task-cta__wrapper">
            <div id="task-cta" class="elevation-1">
                @if ($task->status->name == "completed")
                    ...
                    <!-- Completed -->
                    <div id="task-cta__title">@lang("tasks.view_cta_completed_title")</div>
                    <div id="task-cta__text">@lang("tasks.view_cta_completed_text")</div>
                ...
                @else
                    ...
                    @if ($task->is_assigned)
                        ...
                        @if ($task->has_outstanding_reports)
                            ...
                            @if ($task->has_unread_reviews)
                                ...
                                <!-- Has unread review -->
                                <div id="task-cta__title">@lang("tasks.view_cta_reviewed_title")</div>
                                <div id="task-cta__text">@lang("tasks.view_cta_reviewed_text")</div>
                                <div id="task-cta__button">
                                    <v-btn color="primary" href="{{ route('tasks.progress-report', ['slug' => $task->slug, 'uuid' => $task->outstanding_reports[0]->uuid]) }}" depressed>
                                        @lang("tasks.view_cta_reviewed_button")
                                    </v-btn>
                                </div>
                            ...
                            @else
                                ...
                                <!-- Awaiting review -->
                                <div id="task-cta__title">@lang("tasks.view_cta_awaiting_review_title")</div>
                                <div id="task-cta__text">@lang("tasks.view_cta_awaiting_review_text")</div>
                                <div id="task-cta__button">
                                    <v-btn color="primary" href="{{ route('tasks.progress-report', ['slug' => $task->slug, 'uuid' => $task->outstanding_reports[0]->uuid]) }}" depressed>
                        ...
                        @else
                            ...
                            <div id="task-cta__title">@lang("tasks.view_cta_awaiting_progress_title")</div>
                            <div id="task-cta__text">@lang("tasks.view_cta_awaiting_progress_text")</div>
                            <div id="task-cta__button">
                                <v-btn color="primary" href="{{ route('tasks.report-progress', ['slug' => $task->slug]) }}" depressed>
                                    @lang("tasks.view_cta_awaiting_progress_button")
                                </v-btn>
                            </div>
                    ...
                    @elseif ($task->is_owner)
                        ...
                        @if ($task->is_open)
                            ...
                            <div id="task-cta__title">@lang("tasks.view_cta_awaiting_positions_filled_title")</div>
                            <div id="task-cta__text">
                                @if ($task->num_open_positions == 1)
                                    @lang("tasks.view_cta_awaiting_positions_filled_text_singular")
                                @else
                                    @lang("tasks.view_cta_awaiting_positions_filled_text_multiple")
                                @endif
                            </div>
                        ...
                        @else
                            ...
                            @if ($task->has_outstanding_reports)
                                ...
                                <!-- Outstanding reports -->
                                <div id="task-cta__title">@lang("tasks.view_cta_outstanding_reports_title")</div>
                                <div id="task-cta__text">@lang("tasks.view_cta_outstanding_reports_text")
                                <div id="task-cta__button">
                                    <v-btn color="primary" href="{{ route('tasks.progress-report', ['slug' => $task->slug, 'uuid' => $task->outstanding_reports[0]->uuid]) }}" depressed>
                                        @lang("tasks.view_cta_outstanding_reports_button")
                                    </v-btn>
                                </div>
                            ...
                            @else
                                ...
                                <div id="task-cta__title">@lang("tasks.view_cta_awaiting_reports_title")</div>
                                <div id="task-cta__text">@lang("tasks.view_cta_awaiting_reports_text")</div>
                                <div id="task-cta__image" style="background-image: url({{ asset('storage/images/undraw/season_change.svg') }}); right: -60px; bottom: -67px;"></div>
                    ...
                    @else
                        ...
                        @if ($task->is_open)
                            ...
                            <div id="task-cta__title">@lang("tasks.view_cta_open_title")</div>
                            <div id="task-cta__text">
                                @if ($task->num_open_positions == 1)
                                    @lang("tasks.view_cta_open_text_singular")
                                @else
                                    @lang("tasks.view_cta_open_text_multiple", ["positions" => $task->num_open_positions])
                                @endif
                            </div>
                            @can("assign-to-self", $task)
                                <div id="task-cta__button">
                                    <v-btn color="primary" href="{{ route('tasks.assign-to-me', $task->slug) }}">
                                        @lang("tasks.view_cta_open_button")
                                    </v-btn>
                                </div>
                            @endcan
                        ...
                        @else
                            ...
                            <!-- Closed positions -->
                            <div id="task-cta__title">@lang("tasks.view_cta_positions_filled_title")</div>
                            <div id="task-cta__text">@lang("tasks.view_cta_positions_filled_text")</div>
                            <div id="task-cta__assignees-label">@lang("tasks.view_cta_positions_filled_assignees")</div>
            ...
            <div class="content-section">
                ...
                <div id="task-content">
                    ...
                    <div class="details elevation-1">
                        ...
                        <div class="detail">
                            <div class="key">@lang("tasks.view_author")</div>
                            <div class="val">
                    ...
                    <!-- Tags -->
                    <div class="content-box elevation-1">
                        <h3 class="content-subtitle">@lang("tasks.view_tags")</h3>
                        @if ($task->tags()->count())
                            <div id="task-tags">
