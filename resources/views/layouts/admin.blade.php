        ...
        <v-app id="app" class="@if(Request::is('/')) home @endif">
            ...
            <mobile-navigation>
                <a class="sidemenu-link" href="{{ route('admin.dashboard') }}">
                    <span class="sidemenu-link__text">@lang("admin.link_dashboard")</div>
                </a>
                <a class="sidemenu-link" href="{{ route('admin.users') }}">
                    <span class="sidemenu-link__text">@lang("admin.link_manage_users")</span>
                </a>
                <a class="sidemenu-link" href="{{ route('admin.settings') }}">
                    <span class="sidemenu-link__text">@lang("admin.link_settings")</span>
                </a>
                <a class="sidemenu-link" href="{{ route('home') }}">
                    <span class="sidemenu-link__text">@lang("admin.link_to_frontend")</div>
                </a>
                <a class="sidemenu-link" href="{{ route('auth.logout') }}">
                    <span class="sidemenu-link__text">@lang("admin.link_logout")</div>
                </a>
            </mobile-navigation>
