...
return [
    ...
    "overview_seniorities" => "Seniorities",
    "overview_filters" => "Filters",
    "overview_filters_description" => "What are you looking for?",
    "overview_filters_view_results" => "View results",
    ...
    "view_awaiting_progress" => "Report your progress",
    "view_awaiting_progress_title" => "Have you made some progress?",
    "view_awaiting_progress_text" => "Report your work so the task owner can further process it.",
    "view_awaiting_progress_button" => "Report progress",
    ...
    "view_remote_work_title" => "Location independent",
    ...
    "view_sign_up_title" => "There's an available position!",
    "view_sign_up_description" => "Does this task look like something you could do? Sign yourself up and get started!",
    "view_sign_up_button" => "Sign me up",
    "view_actions" => "",
