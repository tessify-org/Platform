...
return [
    ...
    "form_status" => "Status",
    "form_no_statuses" => "Geen statussen gevonden",
    ...
    "team_view_dialog_update" => "Aanpassen",
    "team_view_dialog_kick" => "Kick",
    "team_update_dialog_title" => "Teamlid aanpassen",
    "team_update_dialog_user" => "Gebruiker",
    "team_update_dialog_roles" => "Rollen",
    "team_update_dialog_cancel" => "Annuleren",
    "team_update_dialog_submit" => "Opslaan",
    "team_kick_dialog_title" => "Kick teamlid",
    "team_kick_dialog_text" => "Weet je zeker dat je deze gebruiker wilt verwijderen uit het team?",
    "team_kick_dialog_reason" => "Reden",
    "team_kick_dialog_reason_hint" => "Optioneel.",
    "team_kick_dialog_cancel" => "Annuleren",
    "team_kick_dialog_submit" => "Kick gebruiker",

    "team_applications_title" => "Aanmeldingen",
    "team_applications_no_records" => "Momenteel zijn er geen openstaande aanmeldingen.",
    "team_applications_view_dialog_title" => "Aanmelding",
    "team_applications_view_dialog_user" => "Gebruiker",
    "team_applications_view_dialog_role" => "Rol",
    "team_applications_view_dialog_motivation" => "Motivatie",
    "team_applications_view_dialog_date" => "Datum",
    "team_applications_view_dialog_back" => "Terug",
    "team_applications_view_dialog_deny" => "Afwijzen",
    "team_applications_view_dialog_accept" => "Accepteren",
