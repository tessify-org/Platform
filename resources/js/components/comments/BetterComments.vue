    ...
    <div class="comments" :class="{ 'standalone': isStandalone }">
                ...
                <div class="comment-footer">
                    <div class="comment-footer__left">
                        <div class="comment-author">
                            ...
                            <div class="comment-author__text">{{ comment.user.formatted_name }}</div>
                        </div>
                    </div>
        ...
        <div class="comments__form" :class="{ 'elevation-2': isStandalone }">
            ...
            <div class="form-field">
                <v-textarea :loading="form.loading" v-model="form.comment" maxlength="255" auto-grow rows="3" counter></v-textarea>
            </div>

            <!-- Actions -->
            <div class="comments__form-actions">
                <v-btn color="primary" @click="onClickPost" :loading="form.loading" :disabled="submitCommentDisabled">{{ strings.create_submit }}</v-btn>
            </div>
        ...
        <v-dialog v-model="dialogs.edit.show" width="500">
            <div class="dialog" v-if="dialogs.edit.index !== null">
                ...
                <div class="dialog-content">
                    ...
                    <!-- Comment -->
                    <div class="form-field">
                        <v-textarea :loading="dialogs.edit.loading" v-model="dialogs.edit.form.comment" maxlength="255" counter auto-grow rows="3"></v-textarea>
                    </div>
                </div>
                <!-- Controls -->
    ...
    export default {
        ...
        methods: {
            ...
            paginateComments() {
                ...
                this.paginatedComments = this.mutableComments.slice(start_slicing_at, stop_slicing_at);
                console.log("pc: ", this.paginatedComments);
