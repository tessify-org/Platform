<template>
    <div id="project-dashboard-sidebar-statuses" class="project-overview__sidebar-panel elevation-1">
...
<script>
    ...
    export default {
        ...
        data: () => ({
            tag: "[project-dashboard-sidebar-statuses]",
            mutableStatuses: [],
        }),
        computed: {
            hasHint() {
        ...
        methods: {
            ...
            onCheckboxValueChanged(index) {
                ...
                EventBus.$emit("project-dashboard__selected-statuses", selected);
            }
        },
        mounted() {
            this.initialize();
