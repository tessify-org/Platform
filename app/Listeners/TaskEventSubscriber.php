...
class TaskEventSubscriber
{
    ...
    {
        // CRUD events
        $events->listen('App\Events\Tasks\TaskCreated', 'App\Listeners\TaskEventSubscriber@handleTaskCreated');
        $events->listen('App\Events\Tasks\TaskUpdated', 'App\Listeners\TaskEventSubscriber@handleTaskUpdated');
        $events->listen('App\Events\Tasks\TaskDeleted', 'App\Listeners\TaskEventSubscriber@handleTaskDeleted');
        
        // Assignments
        $events->listen('App\Events\Tasks\TaskAssigned', 'App\Listeners\TaskEventSubscriber@handleTaskAssigned');
        $events->listen('App\Events\Tasks\TaskUnassigned', 'App\Listeners\TaskEventSubscriber@handleTaskUnassigned');

        // Progression
        $events->listen('App\Events\Tasks\TaskCompleted', 'App\Listeners\TaskEventSubscriber@handleTaskCompleted');
        $events->listen('App\Events\Tasks\TaskProgressReported', 'App\Listeners\TaskEventSubscriber@handleTaskProgressReported');
    }
