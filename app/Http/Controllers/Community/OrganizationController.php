...
use App\Events\Users\UserSusbcribedOrganization;
use App\Events\Users\UserUnsusbcribedOrganization;
...
class OrganizationController extends Controller
{
    public function getOverview()
    {
        ...
        return view("pages.community.organizations.overview", [
    ...
    public function getView($slug)
    {
        ...
        if (!$organization)
        {
            flash(__("organizations.not_found"))->error();
            return redirect()->route("organizations");       
        }
        
        // Render the view organization page
        return view("pages.community.organizations.view", [
    ...
    public function getSubscribe($slug)
    {
        ...
        flash(__("organizations.view_subscribed"))->success();
    ...
    public function getUnsubscribe($slug)
    {
        ...
        // Flash message & redirect to the view organization page
        flash(__("organizations.view_unsubscribed"))->success();
        return redirect()->route("organizations.view", ["slug" => $organization->slug]);
    }
    ...
    public function getViewDepartment($slug, $departmentSlug)
    {
        ...
        if (!$department)
        {
            flash(__("organizations.department_not_found"));
            return redirect()->route("organizations.view", $slug);
        }

        // Render the view organization department page
        return view("pages.community.organizations.view-department", [
            "organization" => $organization,
