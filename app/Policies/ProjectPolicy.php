...
class ProjectPolicy
{
    ...
    public function updateStatus(User $user, Project $project)
    {
        return $project->author_id == $user->id
            ? Response::allow()
            : Response::deny(__("policies.status_deny"));
    }
    ...
    public function manageTeamRoles(User $user, Project $project)
    {
        return $project->author_id == $user->id
            ? Response::allow()
            : Response::deny(__("policies.manage_team_roles_deny"));
    }
    ...
    public function manageTeamMemberApplications(User $user, Project $project)
    {
        return $project->author_id == $user->id
            ? Response::allow()
            : Response::deny(__("policies.manage_team_applications_deny"));
    }
    ...
    public function manageTeamMembers(User $user, Project $project)
    {
        return $project->author_id == $user->id
            ? Response::allow()
            : Response::deny(__("policies.manage_team_members_deny"));
    }
    ...
    public function applyForTeam(User $user, Project $project)
    {
        ...
        {
            return Response::deny(__("policies.apply_for_team_deny_owner"));
        }

        // Make sure the user is not already a team member
        if (Projects::isTeamMember($project, $user))
        {
            return Response::deny(__("policies.apply_for_team_deny_team_member"));
        }
        ...
        {
            return Response::deny(__("policies.apply_for_team_deny_application_exists"));
        }
