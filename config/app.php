...
return [
    ...
    */
    ...
    'aliases' => [
        ...
        'AssignmentTypes' => App\Facades\AssignmentTypesFacade::class,
        'BugReports' => App\Facades\BugReportsFacade::class,
        'Comments' => App\Facades\CommentsFacade::class,
        'CompletedTasks' => App\Facades\CompletedTasksFacade::class,
        'Dates' => App\Facades\DatesFacade::class,
        'FaqCategories' => App\Facades\FaqCategoriesFacade::class,
        'Faqs' => App\Facades\Faqs::class,
        ...
        'OrganizationLocations' => App\Facades\OrganizationLocationsFacade::class,
        'Organizations' => App\Facades\OrganizationsFacade::class,
        'OrganizationTypes' => App\Facades\OrganizationTypesFacade::class,
        'ProjectCategories' => App\Facades\ProjectCategoriesFacade::class,
        'ProjectPhases' => App\Facades\ProjectPhasesFacade::class,
        ...
        'Reputation' => App\Facades\ReputationFacade::class,
        'ReputationTransactions' => App\Facades\ReputationTransactionsFacade::class,
        'ReviewRequests' => App\Facades\ReviewRequestsFacade::class,
        'Reviews' => App\Facades\ReviewsFacade::class,
        'Search' => App\Facades\SearchFacade::class,
        'Skills' => App\Facades\SkillsFacade::class,
        'Tags' => App\Facades\TagsFacade::class,
        'TaskCategories' => App\Facades\TaskCategoriesFacade::class,
        'TaskProgressReportAttachments' => App\Facades\TaskProgressReportAttachmentsFacade::class,
        'TaskProgressReportReviews' => App\Facades\TaskProgressReportReviewsFacade::class,
        'TaskProgressReports' => App\Facades\TaskProgressReports::class,
        'TaskSeniorities' => App\Facades\TaskSenioritiesFacade::class,
        'Tasks' => App\Facades\TasksFacade::class,
        'TaskStatuses' => App\Facades\TaskStatuses::class,
